    ...
    <View style={styles.container}>
      ...
      {order && (
        <View style={{ marginTop: '50%', padding: 20, backgroundColor: '#000', borderRadius: 8, marginBottom: 20, alignItems: 'center' }}>
          ...
          <TouchableOpacity onPress={() => navigation.goBack()} style={{ backgroundColor: '#630202', padding: 10, borderRadius: 8 }}>
            <Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 16 }}>Continue Shopping</Text>
          </TouchableOpacity>
        </View>
      )}
      {!order && (
